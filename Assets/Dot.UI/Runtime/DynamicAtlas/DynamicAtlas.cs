...
namespace DotEngine.UI
{
    ...
    public class DynamicAtlas
    {
        ...
        public DynamicAtlas(int width, int height, string name, HeuristicMethod method = HeuristicMethod.RectBestShortSideFit, TextureFormat format = TextureFormat.RGBA32)
        {
        ...
        public bool Insert(Texture2D source, string name = null)
        {
            return Write(source, name);
        }
        ...
        bool Write(Texture2D source, string name)
        {
