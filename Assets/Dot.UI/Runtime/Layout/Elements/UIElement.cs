...
{
    public abstract class UIElement<TController> : MonoBehaviour
        where TController : IUIElementController
    {
        [SerializeField]
        ...
        public string identity
        {
            ...
            set
            {
                if (m_Identity != value)
                {
                    ...
                    controller?.OnIdentityChanged(oldIdentity, value);
                }
            }
        }
        ...
        public int layer
        {
            ...
            set
            {
                ...
                if (oldLayer != value)
                {
                    ...
                    controller?.OnLayerChanged(oldLayer, value);
                }
            }
        }
        ...
        public GameObject parent
        {
            ...
            set
            {
                ...
                if (pGO != value)
                {
                    ...
                    controller?.OnParentChanged(pGO, value);
                }
            }
        }
