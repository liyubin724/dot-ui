...
{
    [CustomEditor(typeof(UILuaInputField), true)]
    public class UILuaInputFieldEditor : SelectableEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            changedParamValuesProperty = serializedObject.FindProperty("changedFuncValues");

            submitedFuncNameProperty = serializedObject.FindProperty("submitedFuncName");
            submitedParamValuesProperty = serializedObject.FindProperty("submitedFuncValues");
